        ...
        <div id="view">
            ...
            <form wire:submit.prevent="simpan">
                <div class="form-group">
                    ...
                    <input wire:model="pengaduan_data.tgl_pengaduan" type="date" class="form-control">
                    @error('pengaduan_data.tgl_pengaduan')
                    <i class="text-danger"> {{ $message }}</i>
                    @enderror
                </div>
                <div class="form-group">
                    <label for="judul_pengaduan">judul pengaduan</label>
                    <input wire:model="pengaduan_data.judul_pengaduan" type="text" class="form-control">
                    @error('pengaduan_data.judul_pengaduan')
                    <i class="text-danger"> {{ $message }}</i>
                    @enderror
                </div>
                <div class="form-group">
