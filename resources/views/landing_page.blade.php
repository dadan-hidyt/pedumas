                        ...
                        <div class="col col-md-6 col-lg-7">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                  <a class="btn btn-block btn-primary" href="{{ route('login') }}">Login Admin & Petugas</a>
                              </div>
                              <div class="col-md-4 mb-4">
                                <a class="btn btn-block btn-danger" href="{{ route('daftar') }}">Daftar Masyarakat</a>
                            </div>
                            <div class="col-md-4 mb-4">
                                <a class="btn btn-block btn-success" href="{{ route('petugas.daftar') }}">Daftar Petugas</a>
                            </div>
                        </div>
                        @endif
                    </div>
